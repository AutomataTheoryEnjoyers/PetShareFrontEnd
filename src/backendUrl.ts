...
// gr 18
export const ADOPTER_URL = BACKEND_URL;
export const ANNOUNCEMENT_URL = BACKEND_URL;
export const REPORT_URL = BACKEND_URL;
export const SHELTER_URL = BACKEND_URL;

// gr 17
// export const ADOPTER_URL = "https://petshare-adopterapi-dev.azurewebsites.net/";
// export const ANNOUNCEMENT_URL =
//   "https://petshare-announcementsapi-dev.azurewebsites.net/";
